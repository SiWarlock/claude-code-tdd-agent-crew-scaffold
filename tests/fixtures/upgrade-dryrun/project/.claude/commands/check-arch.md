...
1. Read the lookup table in `app/CLAUDE.md` (top section, near "Lookup table — where to find canonical info").
...
Recommendation: add a row to the app/CLAUDE.md lookup table:
| <topic> | <file> | §<section> |
```
